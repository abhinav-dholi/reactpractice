...
export class News extends Component {
    ...
    handleNextClick = async () => {
        ...
        //     let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=20673ffdc3a94de9890a9f2e48032e8b&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
